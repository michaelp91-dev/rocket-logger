            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p>T/W Ratio: <strong>${flight.estimates.thrust_to_mass_ratio ? flight.estimates.thrust_to_mass_ratio.toFixed(2) : 'N/A'} N/kg</strong></p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
            <div class="bg-gray-900/50 p-4 rounded-lg">
                ...
                <div class="mt-3 pt-3 border-t border-gray-600">
                    ...
                    <div class="grid grid-cols-2 gap-2 text-sm">
                        <div><strong>COP:</strong> ${rocket.calculate_cop().toFixed(3)}m</div>
                        <div><strong>Mid Chord:</strong> ${rocket.fin_mid_chord_length.toFixed(3)}m</div>
                    </div>
                </div>
            </div>
...
function calculatePerformance(rocketData, engineData, launchRodLength = 1.0) {
    ...
    // Launch rod velocity calculation (from article)
    const thrust_to_mass_ratio = (Math.pow(10, 2) / (2 * launchRodLength)) + g; // T/m needed for 10 m/s
    const min_thrust_needed = loaded_mass * thrust_to_mass_ratio;
    const launch_rod_velocity = Math.sqrt(2 * ((motor.peak_thrust - loaded_mass * g) / loaded_mass) * launchRodLength);
    ...
    if (currentModalType === 'rocket') {
        ...
        html = `
            ...
            <div class="mt-4 pt-4 border-t border-gray-600">
                <h5 class="font-semibold text-cyan-300 mb-2">Calculated Values</h5>
                <div class="grid grid-cols-2 gap-4">
                    <div><strong>Center of Pressure:</strong> ${rocket.calculate_cop().toFixed(3)}m</div>
                    <div><strong>Mid Chord Length:</strong> ${rocket.fin_mid_chord_length.toFixed(3)}m</div>
                </div>
            </div>
        `;
    } else {
