...
class Rocket {
    ...
    calculate_cop() {
        ...
        const nose_cp_factor = this.nose_cone_type === 'cone' ? 0.666 : 0.466;
        const cn_nose = 2.0;
        const cp_nose = nose_cp_factor * this.nose_cone_length;
        ...
        <div class="space-y-4">
            <div>
                ...
                <ul class="list-disc list-inside space-y-1 pl-2">
                    ...
                    <li>Nose Cone $CP_{nose}$ (${nose_cone_type_label}): $${nose_cp_factor} \\cdot L_{nose}$ = $${nose_cp_factor} \\cdot ${(rocket.nose_cone_length*100).toFixed(2)}\\text{ cm}$ = <strong>${(cp_nose_m*100).toFixed(2)} cm</strong></li>
